...
![Material UI](https://img.shields.io/badge/Material_UI-0A0A0A?style=flat-square&logo=mui&logoColor=007FFF)
![Tailwind CSS](https://img.shields.io/badge/Tailwind_CSS-0A0A0A?style=flat-square&logo=tailwindcss&logoColor=06B6D4)
![Styled Components](https://img.shields.io/badge/Styled_Components-0A0A0A?style=flat-square&logo=styledcomponents&logoColor=DB7093)
![Chart.js](https://img.shields.io/badge/Chart.js-0A0A0A?style=flat-square&logo=chartdotjs&logoColor=FF6384)

### State & Data

![Redux Toolkit](https://img.shields.io/badge/Redux_Toolkit-0A0A0A?style=flat-square&logo=redux&logoColor=764ABC)
![Context API](https://img.shields.io/badge/Context_API-0A0A0A?style=flat-square&logo=react&logoColor=61DAFB)
